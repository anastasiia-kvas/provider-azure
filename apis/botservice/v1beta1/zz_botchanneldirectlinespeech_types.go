...
type BotChannelDirectLineSpeechObservation struct {
	...
	// The ID of the Direct Line Speech Channel.
...
// BotChannelDirectLineSpeech is the Schema for the BotChannelDirectLineSpeechs API. Manages a Direct Line Speech integration for a Bot Channel
